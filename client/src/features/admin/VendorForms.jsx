...
export function VendorProfileModal({ vendor, onClose, onSubmit, submitting = false }) {
  const [form, setForm] = useState({ name: vendor.name || '', description: vendor.description || '', logo_file: null, support_email: vendor.support_email || '', support_phone: vendor.support_phone || '', corporate_catering_enabled: !!vendor.corporate_catering_enabled });
